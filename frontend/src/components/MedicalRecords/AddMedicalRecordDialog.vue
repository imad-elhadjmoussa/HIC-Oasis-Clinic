...
const submitFiche = async () => {
    try {
        ...
        const payload = {
            ...
            date_prise_en_charge: newFiche.value.date_prise_en_charge,
        }
    ...
    <Dialog :visible="visible" @update:visible="closeDialog" :style="{ width: '600px' }" header="Create New Fiche"
        ...
        <div class="grid">
            ...
            <div class="field">
                ...
                <DatePicker size="small" v-model="newFiche.date_prise_en_charge" placeholder="Date of prise en charge" class="w-full" showIcon iconDisplay="input" />
            </div>
        </div>

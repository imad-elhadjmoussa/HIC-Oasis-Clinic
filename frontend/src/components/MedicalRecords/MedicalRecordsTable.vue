    ...
    <div>
        <DataTable :value="records" :paginator="true" :rows="5" responsiveLayout="scroll" class="p-datatable-sm">
            ...
            <Column field="status" header="Status" sortable style="width: 150px">
                <template #body="{ data }">
                    <Tag :value="data.status || 'Not Completed'" :severity="getStatusSeverity(data.status)"
                        class="capitalize" />
                </template>
            </Column>
            <Column field="created_at" header="Created At" sortable style="width: 120px">
                <template #body="{ data }">
            ...
            <Column header="Actions" style="width: 180px">
                <template #body="{ data }">
                    <div class="flex gap-2">
                        ...
                        <Button icon="pi pi-trash" label="Delete" class="p-button-sm p-button-danger"

...
<template>
    <div class="p-2">
        ...
        <Card class="p-2">
            <template #title>
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div>
                        <h1 class="text-xl font-bold">Patient Medical Records</h1>
                    </div>
            ...
            <template #content>
                ...
                <div class="flex gap-4 mb-6">
                    <div class="w-full sm:w-1/4">
                        <Dropdown size="small" v-model="filters.filterField" :options="filterOptions"
                            optionLabel="label" optionValue="value" class="w-full" />
                    </div>

                    <div class="flex-1">
                        <InputText size="small" v-model="filters.search" class="w-full"
        ...
        <AddMedicalRecordDialog v-model:visible="addMedicalRecordDialog" @record-added="refreshMedicalRecords" :patient="route.params.id" />
    </div>
</template>

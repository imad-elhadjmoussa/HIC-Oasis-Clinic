...
const closeDialog = () => {
    prestation.value = { prestation_name: '', prestation_code: '', specialty_id: null };
    ...
    <Dialog :visible="visible" @update:visible="$emit('update:visible', $event)" header="Add New Prestation"
        ...
        <div class=" flex flex-col gap-3">
            ...
            <div class="field">
                ...
                <Select size="small" v-model="prestation.specialty_id" optionValue="id" :options="specialties"

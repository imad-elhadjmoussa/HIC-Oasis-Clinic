...
const menuItems = [
    { label: "User Dashboard", icon: "pi pi-home", route: "/users", exact: true },
    { label: "All Users", icon: "pi pi-users", route: "/users/list" },
    { label: "Roles", icon: "pi pi-shield", route: "/users/roles" },
    { label: "Permissions", icon: "pi pi-key", route: "/users/permissions" },

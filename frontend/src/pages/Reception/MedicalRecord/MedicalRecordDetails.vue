...
<template>
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <AgreementCard v-if="medicalRecord" :contractId="medicalRecord.contract_id" @refresh="refreshMedicalRecord"/>
        </div>

        <div class="flex flex-col gap-6">

            <!-- Medical Acts Table -->
            <PrestationsTable v-if="medicalRecord" :prestations="[]"  @refresh="refreshMedicalRecord" />
        </div>

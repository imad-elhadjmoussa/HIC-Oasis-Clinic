        ...
        <Card class="p-2">
            <template #title>
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div>
                        <h1 class="text-xl font-bold">Medical Records</h1>
                    </div>
            ...
            <template #content>
                ...
                <!-- Data Table -->
                <MedicalRecordsTable v-else :records="filteredMedicalRecords" @refresh="refreshMedicalRecords" @record-deleted="refreshMedicalRecords" />
            </template>
        </Card>

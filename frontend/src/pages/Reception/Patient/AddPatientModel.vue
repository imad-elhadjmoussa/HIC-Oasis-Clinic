...
import { bloodTypes, genders, showNotification } from "..";
    ...
    <Dialog :visible="visible" @update:visible="closeDialog" :style="{ width: '700px' }" header="Add New Patient"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <InputMask size="small" v-model="newPatient.national_id_number" mask="9999999999"
                    placeholder="XXXXXXXXXX" class="w-full" />
            </div>
            <div>
            ...
            <div>
                ...
                <DatePicker size="small" v-model="newPatient.date_of_birth" dateFormat="dd-mm-yy" placeholder="dd/mm/yy"
